...
import static com.example.fedor.inventoryapp.data.InventoryContract.InventoryEntry.COLUMN_ITEM_IMAGE;
...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.fedor.inventoryapp/inventory" will map
        ...
        // The content URI of the form "content://com.example.fedor.inventoryapp/inventory/#" will
        ...
        // For example, "content://com.example.fedor.inventoryapp/inventory/3" matches, but
        // "content://com.example.fedor.inventoryapp/inventory" (without a number at the end)
        // doesn't match.
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY +
                "/#", ITEM_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.fedor.inventoryapp/inventory/3",
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String itemImage = values.getAsString(COLUMN_ITEM_IMAGE);
        if (itemImage == null) {
            throw new IllegalArgumentException("Item requires a product image");
        }
